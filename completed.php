...
function sendEmail($to, $subject, $body) {
    ...
    try {
        ...
        $mail->Username   = 'alex@pruebasenatibalvin.site';            //Nombre de usuario SMTP
        $mail->Password   = 'PruebaxD147';                      //Contraseña SMTP
        ...
        //Emisor
        $mail->setFrom('alex@pruebasenatibalvin.site', 'Michel');
